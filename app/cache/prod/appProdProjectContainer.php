...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_0a6a7e33c58d24694f4c842532e89f76');
        ...
        $d->setProxyDir('/opt/lampp/htdocs/Symfony/app/cache/prod/doctrine/orm/Proxies');
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), '45dbd1006ed707639321d28b5104157e81');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => 'php', 'translation.loader.yml' => 'yml', 'translation.loader.xliff' => 'xliff'), array('cache_dir' => '/opt/lampp/htdocs/Symfony/app/cache/prod/translations', 'debug' => false), $this->get('session'));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'mailer_password' => '',
            'locale' => 'en',
            'secret' => '45dbd1006ed707639321d28b5104157e81',
            ...
            'kernel.secret' => '45dbd1006ed707639321d28b5104157e81',
